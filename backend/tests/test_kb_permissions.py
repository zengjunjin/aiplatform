...
class TestGetKbForRead:
    @pytest.mark.asyncio
    async def test_owner_can_read(self, make_db):
    ...
    @pytest.mark.asyncio
    async def test_read_collaborator_can_read(self, make_db):
    ...
    @pytest.mark.asyncio
    async def test_non_collaborator_denied(self, make_db):
        kb = _make_kb(owner_id=10, collaborators=[{"user_id": 20, "permission": "read"}])
        db = make_db(kb)
...
class TestGetKbForWrite:
    @pytest.mark.asyncio
    async def test_owner_can_write(self, make_db):
        kb = _make_kb(owner_id=10)
        db = make_db(kb)
    ...
    @pytest.mark.asyncio
    async def test_write_collaborator_can_write(self, make_db):
    ...
    @pytest.mark.asyncio
    async def test_admin_collaborator_can_write(self, make_db):
    ...
    @pytest.mark.asyncio
    async def test_read_collaborator_denied(self, make_db):
...
class TestGetKbForAdmin:
    @pytest.mark.asyncio
    async def test_owner_can_admin(self, make_db):
        kb = _make_kb(owner_id=10)
        db = make_db(kb)
    ...
    @pytest.mark.asyncio
    async def test_admin_collaborator_can_admin(self, make_db):
        kb = _make_kb(owner_id=10, collaborators=[{"user_id": 20, "permission": "admin"}])
        db = make_db(kb)
    ...
    @pytest.mark.asyncio
    async def test_write_collaborator_denied(self, make_db):
        kb = _make_kb(owner_id=10, collaborators=[{"user_id": 20, "permission": "write"}])
        db = make_db(kb)
        with pytest.raises(ForbiddenError) as exc:
            await kb_service.get_kb_for_admin(1, 20, db)
...
class TestGetKbAlias:
    @pytest.mark.asyncio
    async def test_get_kb_is_read_alias(self, make_db):
...
class TestDeleteKbPermission:
    @pytest.mark.asyncio
    async def test_read_collaborator_cannot_delete(self, make_db):
    ...
    @pytest.mark.asyncio
    async def test_write_collaborator_cannot_delete(self, make_db):
    ...
    @pytest.mark.asyncio
    async def test_admin_collaborator_cannot_delete(self, make_db):
    ...
    @pytest.mark.asyncio
    async def test_non_collaborator_cannot_delete(self, make_db):
        kb = _make_kb(owner_id=10, collaborators=[{"user_id": 20, "permission": "admin"}])
        db = make_db(kb)
        with pytest.raises(ForbiddenError) as exc:
    ...
    @pytest.mark.asyncio
    async def test_owner_can_delete(self, make_db):
        """owner 可以删除自己的知识库。"""
...
class TestUpdateKbPermission:
    @pytest.mark.asyncio
    async def test_read_collaborator_cannot_update(self, make_db):
...
class TestCollaboratorManagementPermission:
    @pytest.mark.asyncio
    async def test_read_collaborator_cannot_add_collaborator(self, make_db):
    ...
    @pytest.mark.asyncio
    async def test_write_collaborator_cannot_remove_collaborator(self, make_db):
